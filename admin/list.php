...
<div class="container mt-4">
    ...
    <div><i class="bi bi-box-seam-fill"></i> Inventory</div>
</div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                <?php foreach ($batches as $b): ?>
                  <tr style="cursor:pointer;" onclick="if(event.target.tagName !== 'BUTTON' && event.target.tagName !== 'FORM') window.location='stockcard.php?batch_id=<?= $b['batch_id'] ?>'">

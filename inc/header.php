...
<head>
    ...
    .table th:nth-child(1),
    .table td:nth-child(1) { text-align: left; width: 20%; }
    .table th:nth-child(2),
    ...
    /* Navbar transparency & logout text */
    .navbar {
        background-color: transparent !important; /* make navbar transparent */
    }

    .navbar .nav-link {
        color:  #b30000; /* make text red */
    }

    .navbar .nav-link:hover {
        color: darkred !important; /* optional hover effect */
    }

.navbar-brand {
    color:  #b30000; /* change brand text to red */
}
